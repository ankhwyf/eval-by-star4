                                        ...
                                        <form action="processDetail.do" method="post" onsubmit="">
                                            ...
                                            <table border="1" cellspacing="0" cellpadding="0" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="textarea <%=j%>-score" contenteditable="true" style="height:100%;width:100%;">
                                                            <%=score.second_indicator.get(j).auditor_score%>
                                                        </div>
                                                        <input class="<%=j%>-score-input" name="content" type="hidden" />
                                                    </td><!--审核分-->
